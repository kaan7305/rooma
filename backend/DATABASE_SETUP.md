...
This guide will help you set up PostgreSQL and run the initial database migration for the ROOMA backend.
...
# Create database
CREATE DATABASE rooma_dev;

# Create user (optional, if not using default postgres user)
CREATE USER rooma_user WITH PASSWORD 'your_secure_password';

# Grant privileges
GRANT ALL PRIVILEGES ON DATABASE rooma_dev TO rooma_user;
...
```env
DATABASE_URL="postgresql://username:password@localhost:5432/rooma_dev"
```
...
```
DATABASE_URL="postgresql://postgres:postgres@localhost:5432/rooma_dev"
```

**Custom user:**
```
DATABASE_URL="postgresql://rooma_user:your_password@localhost:5432/rooma_dev"
```

**No password (development only):**
```
DATABASE_URL="postgresql://localhost:5432/rooma_dev"
```
