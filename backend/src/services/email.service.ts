...
export const sendWelcomeEmail = async (email: string, firstName: string): Promise<void> => {
  const html = `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Welcome to ROOMA!</h1>
        </div>
        <div class="content">
          <h2>Hi ${firstName},</h2>
          <p>Welcome to ROOMA - your global student housing platform!</p>
        ...
        <div class="footer">
          <p>&copy; 2025 ROOMA. All rights reserved.</p>
  ...
  await sendEmail(email, 'Welcome to ROOMA!', html);
};
...
export const sendVerificationEmail = async (
  ...
  const html = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2>Hi ${firstName},</h2>
          <p>Thanks for signing up! Please verify your email address to activate your ROOMA account.</p>
  ...
  await sendEmail(email, 'Verify Your Email - ROOMA', html);
};
...
export const sendPasswordResetEmail = async (
  ...
  const html = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2>Hi ${firstName},</h2>
          <p>We received a request to reset your password for your ROOMA account.</p>
  ...
  await sendEmail(email, 'Password Reset Request - ROOMA', html);
};
